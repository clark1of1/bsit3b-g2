...
<section class="relative h-screen bg-cover bg-center" 
           style="background-image: url(htpss://caltechsites-prod-assets.s3.amazonaws.com/scienceexchange/images/wind-turbine-future-energy.2e16d0ba.fill-933x525-c100.jpg">
    <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
      ...
      <p class="text-lg md:text-xl text-gray-300 mb-6 max-w-2xl" data-aos="fade-up">
        Select a level and dodge pollution to save the planet! Use ← → arrows to move. Collect seedlings to gain points!
        </p>
